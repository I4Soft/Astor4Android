...
public class JGenProg extends AstorCoreEngine {
	...
	protected void setFitnessOfPopulation() throws Exception {
		log.debug("Calculating fitness for original program variant.");
		
		//Saving variant on disk
		...
		if (validInstance) {
			throw new IllegalStateException("The application under repair has no failing test cases");
		}
	...
	protected boolean validateInstance(ProgramVariant variant, TestCasesProgramValidationResult validationResult) {
