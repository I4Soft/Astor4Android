 ...
 * [MODIFIED]
 * Difference from the original ProjectRepairFacade:
 *		- Modified the second function calculateSuspicious to work with
 *		  the fault localization for Android. It seems like this function
 *		  was originaly made to work only with GZoltar.
 *		- Changed the "No suspicious for analyze" action.
 */
